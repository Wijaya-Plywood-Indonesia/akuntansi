                ...
                <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 shadow-lg flex flex-col overflow-hidden sticky top-4">
                    ...
                    @else
                        ...
                        @if ($isDp && $sisa > 0)
                            ...
                            <div class="p-4 lg:p-5 space-y-3 border-b border-gray-100 dark:border-gray-800">
                                <h3 class="text-[10px] font-black text-gray-500 uppercase tracking-wider flex items-center gap-1.5">
                                    <x-heroicon-o-banknotes class="w-4 h-4 text-primary-500" /> Tambah DP
                                </h3>
                                ...
                                <button wire:click="tambahDp" wire:confirm="Simpan setoran DP ini? Jurnal Uang Muka Pembelian akan langsung dicatat."
                                    class="w-full flex items-center justify-center gap-2 bg-amber-500 hover:bg-amber-600 text-white font-bold text-xs py-2 rounded-lg shadow-sm transition-all active:translate-y-0.5 tracking-wide">
                        ...
                        <div class="p-4 lg:p-5 space-y-3">
                            @if ($isDp && $sisa > 0)
                                <div class="p-3 bg-amber-50 dark:bg-amber-900/20 rounded-lg border border-amber-100 dark:border-amber-800/50">
                                    <p class="text-[11px] text-amber-700 dark:text-amber-300 leading-relaxed">
                                        Nota DP ini masih punya sisa tagihan <strong>Rp {{ number_format($sisa) }}</strong>.
                                        Isi pelunasan sisa di bawah — nominalnya <strong>wajib pas</strong> menutup sisa
                                        (tidak bisa dicicil lagi di titik ini). Ini akan mengakui <strong>Persediaan</strong>
                                        &amp; membalik seluruh <strong>Uang Muka Pembelian</strong> sekaligus.
                                    </p>
                                </div>
                                ...
                                <div class="flex flex-col gap-1.5"
                                    ...
                                    <div class="flex justify-between items-center">
                                        <label class="text-[10px] font-black text-gray-500 uppercase tracking-wider ml-1">Pelunasan Sisa</label>
                                        <button type="button" @click="nominal = '{{ (int) $sisa }}'" class="text-[9px] font-bold text-primary-600 hover:underline uppercase tracking-wide">Bayar Pas</button>
                                    </div>
                                    <div class="flex items-center gap-1.5 border-b border-primary-500 pb-0.5">
                                        <span class="text-sm font-bold text-primary-600">Rp</span>
                            ...
                            @else
                                <div class="p-3 bg-amber-50 dark:bg-amber-900/20 rounded-lg border border-amber-100 dark:border-amber-800/50">
                                    <p class="text-[11px] text-amber-700 dark:text-amber-300 leading-relaxed">
                                        Pembelian ini sudah <strong>lunas</strong>{{ $isDp ? ' (DP sudah menutup 100%)' : ' dibayar dimuka' }}.
