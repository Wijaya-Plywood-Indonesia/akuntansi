                ...
                <div class="bg-white dark:bg-gray-900 border-r border-b border-gray-200 dark:border-gray-800 p-2.5 flex items-center justify-between gap-3 text-xs hover:bg-gray-50/50 dark:hover:bg-gray-950/30 transition-colors duration-150">
                    ...
                    <div class="text-right flex-shrink-0">
                        <div>
                            ...
                            <span class="text-[9px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider" x-text="item.satuan"></span>
                        </div>
                        <div x-show="item.m3 != 0" class="mt-0.5">
                            <span class="font-mono font-semibold text-[10px] text-amber-600 dark:text-amber-400" x-text="formatM3(item.m3)"></span>
                            <span class="text-[9px] font-bold text-gray-400 dark:text-gray-500">m³</span>
                        </div>
                    </div>
