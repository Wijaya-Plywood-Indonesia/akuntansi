            ...
            <div class="flex flex-wrap items-center gap-6 w-full lg:w-auto">
                <div class="flex items-center gap-2">
                    ...
                    <input type="text" wire:model.live="no_nota"
                        class="px-2 py-1 bg-gray-50/50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-700 rounded text-xs font-black text-primary-600 font-mono focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 w-52 transition-all" />
                </div>
