...
<head>
    ...
    <style>
        ...
        /* =====================
           WATERMARK BELUM LUNAS (1 besar, area dibatasi di atas garis potong)
           ===================== */
        .watermark {
            position: absolute;
            top: 0;
...
<body onload="window.print()">
    <div class="page">
        ...
        @if ($penjualan->status_transaksi !== 'LUNAS')
            <div class="watermark"><span>{{ strtoupper('BELUM LUNAS') }}</span></div>
        @endif
            ...
            <tbody>
                @foreach ($penjualan->details as $i => $detail)
                    <tr>
                        ...
                        @php $totalPotonganItem = ($detail->potongan ?? 0) * $detail->qty; @endphp
                    ...
                    <td colspan="8" class="text-center">
                        @if ($totalPotonganNota > 0)
                            <p style="margin-top: 6px; font-size: 11px">
                                <em>
                                    🎉 Anda menghemat
                                    <strong>Rp {{ number_format($totalPotonganNota) }}</strong>
